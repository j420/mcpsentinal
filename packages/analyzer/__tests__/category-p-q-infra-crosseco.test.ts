...
// The v2 rules require structured Dockerfile / YAML inputs with proper
// header context (FROM directives, k8s securityContext blocks, etc.) —
// bare source_code snippets used by these legacy tests no longer satisfy
// the v2 input contract. Comprehensive per-rule coverage lives in:
//   packages/analyzer/src/rules/implementations/p1-docker-socket-mount/__tests__/index.test.ts
//   packages/analyzer/src/rules/implementations/p2-dangerous-container-capabilities/__tests__/index.test.ts
//   packages/analyzer/src/rules/implementations/p3-cloud-metadata-access/__tests__/index.test.ts
//   packages/analyzer/src/rules/implementations/p4-tls-bypass/__tests__/index.test.ts
//   packages/analyzer/src/rules/implementations/p5-secrets-in-build-layers/__tests__/index.test.ts
//   packages/analyzer/src/rules/implementations/p6-ld-preload-hijack/__tests__/index.test.ts
//   packages/analyzer/src/rules/implementations/p7-host-filesystem-mount/__tests__/index.test.ts
