 ...
 * N1, N2, N3, N7, N8, N10: moved to per-rule directories in Phase 1
 *   chunk 1.8 — see src/rules/implementations/n*-*\/__tests__/.
...
// ═══════════════════════════════════════════════════════════════════════════════
// N1, N2, N3, N7, N8, N10 — migrated to per-rule Rule Standard v2 directories
// in Phase 1 chunk 1.8. Comprehensive tests live at
//   src/rules/implementations/n{1,2,3,7,8,10}-*\/__tests__/index.test.ts
// Legacy blocks asserting the drifted jsonrpc-protocol-v2.ts semantics were
// removed alongside the deletion of jsonrpc-protocol-v2.ts.
// ═══════════════════════════════════════════════════════════════════════════════
