...
export const metadata: Metadata = {
  ...
  description:
    "The world's most comprehensive security intelligence registry for MCP servers. 22,000+ servers scanned across 76 detection rules covering prompt injection, supply chain attacks, dependency vulnerabilities, and more.",
  keywords: [
    "MCP",
  ...
  openGraph: {
    ...
    description:
      "22,000+ MCP servers scanned. 76 detection rules. Know which servers are safe before they touch your agent.",
    images: [
      {
        url: `${SITE_URL}/og.png`,
        width: 1200,
...
const organizationJsonLd = {
  ...
  description:
    "The world's most comprehensive MCP server security intelligence registry. 22,000+ servers scanned, 76 detection rules, zero guesswork.",
