...
const RULE_CATEGORIES = [
  ...
  },
  {
    ...
    rules: [
      { id: "K1", name: "Absent Structured Logging", sev: "high" },
      ...
      { id: "K5", name: "Auto-Approve Bypass", sev: "critical" },
      { id: "K6", name: "Overly Broad OAuth Scopes", sev: "high" },
      { id: "K7", name: "Long-Lived Tokens", sev: "high" },
      { id: "K8", name: "Cross-Boundary Credential Sharing", sev: "critical" },
      ...
      { id: "K16", name: "Unbounded Recursion", sev: "high" },
