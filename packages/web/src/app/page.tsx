...
const FEATURED_ORGS: FeaturedOrg[] = [
  { name: "GitHub MCP Server", org: "GitHub", slug: "github-mcp-server", desc: "Repos, issues, PRs, code search, Actions.", color: "#24292f", initials: "GH" },
  ...
  { name: "Cloudflare MCP Server", org: "Cloudflare", slug: "mcp-server-cloudflare", desc: "Workers, R2, KV, D1, Durable Objects.", color: "#F48120", initials: "CF" },
  { name: "Linear MCP", org: "Linear", slug: "linear-mcp", desc: "Issues, projects, cycles, teams.", color: "#5E6AD2", initials: "LN" },
  { name: "Notion MCP", org: "Notion", slug: "notion-mcp", desc: "Pages, databases, blocks, search.", color: "#191919", initials: "NT" },
  ...
  { name: "Slack MCP Server", org: "Slack", slug: "slack-mcp-server", desc: "Channels, messages, users, reactions.", color: "#611f69", initials: "SL" },
  { name: "Google Drive MCP", org: "Google", slug: "google-drive-mcp", desc: "Drive files, Docs, Sheets, permissions.", color: "#4285F4", initials: "GG" },
  { name: "Microsoft Graph MCP", org: "Microsoft", slug: "microsoft-graph-mcp", desc: "Office 365, Teams, OneDrive, Outlook.", color: "#737373", initials: "MS" },
  { name: "AWS MCP Server", org: "AWS", slug: "aws-mcp-server", desc: "S3, Lambda, DynamoDB, CloudFormation.", color: "#232F3E", initials: "AW" },
  { name: "Vercel MCP Server", org: "Vercel", slug: "vercel-mcp-server", desc: "Deployments, domains, edge functions.", color: "#171717", initials: "VC" },
  ...
  { name: "MongoDB MCP Server", org: "MongoDB", slug: "mongodb-mcp-server", desc: "Atlas clusters, collections, aggregation.", color: "#00684A", initials: "MG" },
  { name: "Redis MCP Server", org: "Redis", slug: "redis-mcp-server", desc: "Key-value ops, streams, pub/sub.", color: "#D82C20", initials: "RD" },
  ...
  { name: "Shopify MCP Server", org: "Shopify", slug: "shopify-mcp-server", desc: "Products, orders, customers, inventory.", color: "#7AB55C", initials: "SH" },
  ...
  { name: "HubSpot MCP Server", org: "HubSpot", slug: "hubspot-mcp-server", desc: "Contacts, deals, tickets, marketing.", color: "#FF5C35", initials: "HS" },
  ...
  { name: "Jira MCP Server", org: "Jira", slug: "jira-mcp-server", desc: "Issues, sprints, boards, epics.", color: "#0065FF", initials: "JR" },
  ...
  { name: "Bitbucket MCP Server", org: "Bitbucket", slug: "bitbucket-mcp-server", desc: "Repos, pull requests, pipelines.", color: "#2684FF", initials: "BB" },
  ...
  { name: "Terraform MCP Server", org: "HashiCorp", slug: "terraform-mcp-server", desc: "Infrastructure as code, state, plans.", color: "#844FBA", initials: "TF" },
  ...
  { name: "Elastic MCP Server", org: "Elastic", slug: "elastic-mcp-server", desc: "Search, observability, security analytics.", color: "#005571", initials: "EL" },
  { name: "Grafana MCP Server", org: "Grafana", slug: "grafana-mcp-server", desc: "Dashboards, alerts, data sources.", color: "#F46800", initials: "GF" },
  { name: "New Relic MCP Server", org: "New Relic", slug: "new-relic-mcp-server", desc: "APM, infrastructure, logs, NRQL.", color: "#1CE783", initials: "NR" },
  { name: "Splunk MCP Server", org: "Splunk", slug: "splunk-mcp-server", desc: "Search, dashboards, alerts, SPL queries.", color: "#000000", initials: "SP" },
  ...
  { name: "Monday.com MCP Server", org: "Monday", slug: "monday-mcp-server", desc: "Boards, items, updates, automations.", color: "#6161FF", initials: "MN" },
  ...
  { name: "CircleCI MCP Server", org: "CircleCI", slug: "circleci-mcp-server", desc: "Pipelines, workflows, jobs, orbs.", color: "#161616", initials: "CI" },
  ...
  { name: "Planetscale MCP Server", org: "PlanetScale", slug: "planetscale-mcp-server", desc: "Databases, branches, deploy requests.", color: "#191919", initials: "PS" },
