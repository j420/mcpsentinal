...
_Generated: 2026-04-22T13:11:09.183Z_
...
| Registered rules (unique ids) | 0 |
| Registered v1 | 0 |
| Registered v2 | 0 |
| Enabled but unregistered | 164 |
| Detector files | 0 |
| Files with any regex | 0 |
| Files with any technique import | 0 |
...
| Regex literals | 0 |
| new RegExp(...) calls | 0 |
| String-literal arrays > 5 | 0 |
| Rules using taint-ast | 0 |
| Rules using capability-graph | 0 |
| Rules using module-graph | 0 |
| Rules using entropy | 0 |
| Rules using similarity | 0 |
| Rules using EvidenceChainBuilder | 0 |
...
| I1 | Tool Annotation Deception | protocol-surface | critical | Y |  |  | 0 | — | — |
| I2 | Missing Destructive Tool Annotation | protocol-surface | high | Y |  |  | 0 | — | — |
| I3 | Prompt Injection in Resource Metadata | protocol-surface | critical | Y |  |  | 0 | — | — |
| I4 | Dangerous Resource URI Scheme | protocol-surface | critical | Y |  |  | 0 | — | — |
| I5 | Resource-Tool Name Shadowing | protocol-surface | high | Y |  |  | 0 | — | — |
| I6 | Prompt Template Injection | protocol-surface | critical | Y |  |  | 0 | — | — |
| I7 | Sampling Capability Abuse | protocol-surface | critical | Y |  |  | 0 | — | — |
| I8 | Sampling Cost / Resource Theft | protocol-surface | high | Y |  |  | 0 | — | — |
| I9 | Elicitation Credential Harvesting | protocol-surface | critical | Y |  |  | 0 | — | — |
| I10 | Elicitation URL Redirect Risk | protocol-surface | high | Y |  |  | 0 | — | — |
| I11 | Over-Privileged Root Declaration | protocol-surface | high | Y |  |  | 0 | — | — |
| I12 | Capability Escalation Post-Initialization | protocol-surface | critical | Y |  |  | 0 | — | — |
| I13 | Cross-Config Lethal Trifecta | protocol-surface | critical | Y |  |  | 0 | — | — |
| I14 | Rolling Capability Drift | protocol-surface | high | Y |  |  | 0 | — | — |
| I15 | Transport Session Security | protocol-surface | high | Y |  |  | 0 | — | — |
| I16 | Consent Fatigue Exploitation | protocol-surface | high | Y |  |  | 0 | — | — |
...
| J3 | Full Schema Poisoning | threat-intelligence | critical | Y |  |  | 0 | — | — |
| J4 | Health Endpoint Information Disclosure | threat-intelligence | high | Y |  |  | 0 | — | — |
| J5 | Tool Output Poisoning Patterns | threat-intelligence | critical | Y |  |  | 0 | — | — |
| J6 | Tool Preference Manipulation | threat-intelligence | high | Y |  |  | 0 | — | — |
| J7 | OpenAPI Specification Field Injection | threat-intelligence | critical | Y |  |  | 0 | — | — |
...
| L8 | Version Rollback / Downgrade Attack | supply-chain-advanced | high | Y |  |  | 0 | — | — |
| L9 | CI/CD Secret Exfiltration Patterns | supply-chain-advanced | critical | Y |  |  | 0 | — | — |
| L10 | Registry Metadata Spoofing | supply-chain-advanced | high | Y |  |  | 0 | — | — |
...
| L15 | Update Notification Spoofing | supply-chain-advanced | high | Y |  |  | 0 | — | — |
| M1 | Special Token Injection in Tool Metadata | ai-runtime-exploitation | critical | Y |  |  | 0 | — | — |
| M2 | TokenBreak Boundary Manipulation | ai-runtime-exploitation | high | Y |  |  | 0 | — | — |
| M3 | Reasoning Chain Manipulation | ai-runtime-exploitation | critical | N |  |  | 0 | — | — |
| M4 | Reasoning Loop Induction | ai-runtime-exploitation | high | Y |  |  | 0 | — | — |
| M5 | Tool Position Bias Exploitation | ai-runtime-exploitation | high | Y |  |  | 0 | — | — |
| M6 | Progressive Context Poisoning Enablers | ai-runtime-exploitation | critical | Y |  |  | 0 | — | — |
| M7 | Tool Response Structure Bomb | ai-runtime-exploitation | high | Y |  |  | 0 | — | — |
| M8 | Inference Cost Amplification | ai-runtime-exploitation | high | Y |  |  | 0 | — | — |
| M9 | Model-Specific System Prompt Extraction | ai-runtime-exploitation | critical | Y |  |  | 0 | — | — |
...
| N4 | JSON-RPC Error Object Injection | protocol-edge-cases | critical | Y |  |  | 0 | — | — |
| N5 | Capability Downgrade Deception | protocol-edge-cases | critical | Y |  |  | 0 | — | — |
| N6 | SSE Reconnection Hijacking | protocol-edge-cases | critical | Y |  |  | 0 | — | — |
...
| N9 | MCP Logging Protocol Injection | protocol-edge-cases | critical | Y |  |  | 0 | — | — |
| N10 | Incomplete Handshake Denial of Service | protocol-edge-cases | high | Y |  |  | 0 | — | — |
| N11 | Protocol Version Downgrade Attack | protocol-edge-cases | critical | Y |  |  | 0 | — | — |
| N12 | Resource Subscription Content Mutation | protocol-edge-cases | critical | Y |  |  | 0 | — | — |
| N13 | HTTP Chunked Transfer Smuggling | protocol-edge-cases | critical | Y |  |  | 0 | — | — |
| N14 | Trust-On-First-Use Bypass (TOFU) | protocol-edge-cases | critical | Y |  |  | 0 | — | — |
| N15 | JSON-RPC Method Name Confusion | protocol-edge-cases | critical | Y |  |  | 0 | — | — |
| O1 | Steganographic Data Exfiltration | data-privacy-attacks | critical | N |  |  | 0 | — | — |
| O2 | HTTP Header Covert Channel | data-privacy-attacks | critical | N |  |  | 0 | — | — |
| O3 | AI-Mediated Exfiltration via Tool Arguments | data-privacy-attacks | critical | N |  |  | 0 | — | — |
| O4 | Clipboard and UI Exfiltration Injection | data-privacy-attacks | high | Y |  |  | 0 | — | — |
| O5 | Environment Variable Harvesting | data-privacy-attacks | critical | Y |  |  | 0 | — | — |
| O6 | Server Fingerprinting via Error Responses | data-privacy-attacks | high | Y |  |  | 0 | — | — |
| O7 | Cross-Session Data Leakage | data-privacy-attacks | critical | N |  |  | 0 | — | — |
| O8 | Timing-Based Covert Channel | data-privacy-attacks | high | Y |  |  | 0 | — | — |
| O9 | Ambient Credential Exploitation | data-privacy-attacks | critical | Y |  |  | 0 | — | — |
| O10 | Privacy-Violating Telemetry | data-privacy-attacks | high | Y |  |  | 0 | — | — |
...
| Q1 | Dual-Protocol Schema Constraint Loss | cross-ecosystem-emergent | critical | N |  |  | 0 | — | — |
| Q2 | LangChain Serialization Bridge Injection | cross-ecosystem-emergent | critical | N |  |  | 0 | — | — |
| Q3 | Localhost MCP Service Hijacking | cross-ecosystem-emergent | critical | Y |  |  | 0 | — | — |
| Q4 | IDE MCP Configuration Injection | cross-ecosystem-emergent | critical | Y |  |  | 0 | — | — |
| Q5 | MCP Gateway Trust Delegation Confusion | cross-ecosystem-emergent | critical | N |  |  | 0 | — | — |
| Q6 | Agent Identity Impersonation via MCP | cross-ecosystem-emergent | critical | Y |  |  | 0 | — | — |
| Q7 | Desktop Extension Privilege Chain | cross-ecosystem-emergent | critical | Y |  |  | 0 | — | — |
| Q8 | Cross-Protocol Authentication Confusion | cross-ecosystem-emergent | critical | N |  |  | 0 | — | — |
| Q9 | Agentic Workflow DAG Manipulation | cross-ecosystem-emergent | critical | N |  |  | 0 | — | — |
| Q10 | Multi-Server Capability Composition Attack | cross-ecosystem-emergent | high | Y |  |  | 0 | — | — |
| Q11 | Code Suggestion Poisoning via MCP | cross-ecosystem-emergent | critical | N |  |  | 0 | — | — |
| Q12 | Cross-Jurisdiction Data Routing via MCP | cross-ecosystem-emergent | high | N |  |  | 0 | — | — |
| Q13 | MCP Bridge Package Supply Chain Attack | cross-ecosystem-emergent | critical | Y |  |  | 0 | — | — |
| Q14 | Concurrent MCP Server Race Condition | cross-ecosystem-emergent | high | N |  |  | 0 | — | — |
| Q15 | A2A/MCP Protocol Boundary Confusion | cross-ecosystem-emergent | high | Y |  |  | 0 | — | — |
...
- **I1**: enabled in YAML but no TypedRule registration found
- **I2**: enabled in YAML but no TypedRule registration found
- **I3**: enabled in YAML but no TypedRule registration found
- **I4**: enabled in YAML but no TypedRule registration found
- **I5**: enabled in YAML but no TypedRule registration found
- **I6**: enabled in YAML but no TypedRule registration found
- **I7**: enabled in YAML but no TypedRule registration found
- **I8**: enabled in YAML but no TypedRule registration found
- **I9**: enabled in YAML but no TypedRule registration found
- **I10**: enabled in YAML but no TypedRule registration found
- **I11**: enabled in YAML but no TypedRule registration found
- **I12**: enabled in YAML but no TypedRule registration found
- **I13**: enabled in YAML but no TypedRule registration found
- **I14**: enabled in YAML but no TypedRule registration found
- **I15**: enabled in YAML but no TypedRule registration found
- **I16**: enabled in YAML but no TypedRule registration found
- **J1**: enabled in YAML but no TypedRule registration found
- **J2**: enabled in YAML but no TypedRule registration found
- **J3**: enabled in YAML but no TypedRule registration found
- **J4**: enabled in YAML but no TypedRule registration found
- **J5**: enabled in YAML but no TypedRule registration found
- **J6**: enabled in YAML but no TypedRule registration found
- **J7**: enabled in YAML but no TypedRule registration found
...
- **L8**: enabled in YAML but no TypedRule registration found
- **L9**: enabled in YAML but no TypedRule registration found
- **L10**: enabled in YAML but no TypedRule registration found
...
- **L15**: enabled in YAML but no TypedRule registration found
- **M1**: enabled in YAML but no TypedRule registration found
- **M2**: enabled in YAML but no TypedRule registration found
- **M4**: enabled in YAML but no TypedRule registration found
- **M5**: enabled in YAML but no TypedRule registration found
- **M6**: enabled in YAML but no TypedRule registration found
- **M7**: enabled in YAML but no TypedRule registration found
- **M8**: enabled in YAML but no TypedRule registration found
- **M9**: enabled in YAML but no TypedRule registration found
...
- **N4**: enabled in YAML but no TypedRule registration found
- **N5**: enabled in YAML but no TypedRule registration found
- **N6**: enabled in YAML but no TypedRule registration found
- **N7**: enabled in YAML but no TypedRule registration found
- **N8**: enabled in YAML but no TypedRule registration found
- **N9**: enabled in YAML but no TypedRule registration found
- **N10**: enabled in YAML but no TypedRule registration found
- **N11**: enabled in YAML but no TypedRule registration found
- **N12**: enabled in YAML but no TypedRule registration found
- **N13**: enabled in YAML but no TypedRule registration found
- **N14**: enabled in YAML but no TypedRule registration found
- **N15**: enabled in YAML but no TypedRule registration found
- **O4**: enabled in YAML but no TypedRule registration found
- **O5**: enabled in YAML but no TypedRule registration found
- **O6**: enabled in YAML but no TypedRule registration found
- **O8**: enabled in YAML but no TypedRule registration found
- **O9**: enabled in YAML but no TypedRule registration found
- **O10**: enabled in YAML but no TypedRule registration found
...
- **Q3**: enabled in YAML but no TypedRule registration found
- **Q4**: enabled in YAML but no TypedRule registration found
- **Q6**: enabled in YAML but no TypedRule registration found
- **Q7**: enabled in YAML but no TypedRule registration found
- **Q10**: enabled in YAML but no TypedRule registration found
- **Q13**: enabled in YAML but no TypedRule registration found
- **Q15**: enabled in YAML but no TypedRule registration found
