...
- [ ] **1.13 — `infrastructure-detector.ts` (P1–P7)** — split/merge decision vs 1.12 resolved: 1.12 covered the `docker-k8s-crypto-v2.ts` rules (L3/K19/P8/P9/P10); 1.13 still owns P1–P7 (DockerSocketMount, DangerousCapabilities, CloudMetadataAccess, TLSBypass, SecretsInBuildLayers, LDPreload, HostFilesystemMount) from `infrastructure-detector.ts`.
